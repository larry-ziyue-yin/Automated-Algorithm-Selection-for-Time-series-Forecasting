...
class RatioSolved(Evaluate):
    '''
        Calculate the solved instances ratio
    '''
    ...
    def __init__(self, ia_runtime_matrix, cutoff_time, pred_ia_rank_matrix = None):
        ...
        Constructor
        '''
        super(RatioSolved, self).__init__("Solved Instances Ratio", ia_data_matrix = ia_runtime_matrix, pred_ia_rank_matrix = pred_ia_rank_matrix)
    ...
    def kth_oracle(self, k):
        ...
        self.kth_oracle_perf_dict[k] = float( num_solved / float(len(self.ia_data_matrix)) )
    ...
    def kth_single_best(self, k):
        ...
        self.kth_single_best_dict[k] = float( single_best_num_solved / float(len(self.ia_data_matrix)) )
    ...
    def random(self):
        ...
        self.random_perf = np.sum(pi_num_solved) / float(len(self.ia_data_matrix))
